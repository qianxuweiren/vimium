...
(function() {
  ...
  VomnibarUI = (function() {
    ...
    VomnibarUI.prototype.reset = function() {
      ...
      if ((ref = this.completer) != null) {
        ref.reset();
      }
    };

    VomnibarUI.prototype.updateSelection = function() {
      var i, j, queryTerms, ref;
      ...
      for (i = j = 0, ref = this.completionList.children.length; j < ref; i = j += 1) {
    ...
    VomnibarUI.prototype.onKeyEvent = function(event) {
      ...
      if (action === "dismiss") {
        ...
        isCustomSearchPrimarySuggestion = ((ref = this.completions[this.selection]) != null ? ref.isPrimarySuggestion : void 0) && ((ref1 = this.lastReponse.engine) != null ? ref1.searchUrl : void 0);
